...
import torch
from DeepRobust.deeprobust.graph.defense import GCN_softmax, GCN_Median, GCNJaccard, GCNSVD, MedianGCN, GCNJaccard_directed
...
if __name__ == '__main__':
      ...
      try:
          result = pkl.load(open(f'results_new/result_copy_{args.model}_{args.attack}_{args.dataset}_{args.constraint_percentage}_{args.cost_scheme}.pkl', 'rb'))
          exit_ = True
    ...
    #   modified_adj = torch.from_numpy(modified_adj[0])
      ...
      pkl.dump(result, open(f'results_new/result_copy_{args.model}_{args.attack}_{args.dataset}_{args.constraint_percentage}_{args.cost_scheme}.pkl', 'wb'))