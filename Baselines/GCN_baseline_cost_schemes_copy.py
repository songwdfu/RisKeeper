...
if __name__ == '__main__':
      ...
      try:
          result = pkl.load(open(f'results/result_{args.model}_{args.attack}_{args.dataset}_{args.cost_scheme}_{args.perturb_ratio}_{args.cc}_{args.seed}.pkl', 'rb'))
          exit_ = True
      except:
          exit_ = False
          pass
    ...
    #   perturbations = int(ptb_rate * (adj.shape[0]//2))
      ...
      if args.attack == 'Metattack':
        ...
        # hyper_c = 0.001*1000/perturbations
        # hyper_c = 0
    ...
    #   modified_adj = torch.from_numpy(modified_adj[0])
      ...
      pkl.dump(result, open(f'results/result_{args.model}_{args.attack}_{args.dataset}_{args.cost_scheme}_{args.perturb_ratio}_{args.cc}_{args.seed}.pkl', 'wb'))