...
flags = tf.app.flags
FLAGS = flags.FLAGS
flags.DEFINE_string('dataset', 'alpha', 'Dataset string.')  # 'cora', 'citeseer', 'photo', 'computers'
...
for n in range(10):#FLAGS.train_steps# photo 8 computer 6
    ...
    if n==0:
        ...
        cost, acc, duration = evaluate(features, support, y_test, test_mask, placeholders,hyper_c,lmd,adj)
